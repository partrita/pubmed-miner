...
class TestWorkflowIntegration:
    ...
    def test_complete_workflow_success(self):
        ...
        with patch.object(self.paper_collector, 'search_papers') as mock_search:
            ...
            with patch.object(self.paper_collector, 'get_paper_details') as mock_details:
                ...
                with patch.object(self.citation_service, 'batch_get_citation_counts') as mock_citations:
                    mock_citations.return_value = citation_counts
                    
                    with patch.object(self.impact_factor_service, 'get_impact_factor') as mock_if:
                        mock_if.side_effect = lambda journal: impact_factors.get(journal, 0.0)
                        ...
                        assert len(essential_papers) == 3  # All papers since we have only 3
                        ...
                        with patch.object(self.github_manager, 'create_or_update_issue') as mock_github:
                            ...
                            mock_github.assert_called_once_with(topic.name, essential_papers)
    ...
    def test_workflow_with_api_failures(self):
        ...
        with patch.object(self.paper_collector, 'search_papers') as mock_search:
            ...
            with patch.object(self.paper_collector, 'get_paper_details') as mock_details:
                ...
                with patch.object(self.citation_service, 'get_citation_count') as mock_citations:
    ...
    def test_workflow_with_empty_results(self):
        ...
        with patch.object(self.paper_collector, 'search_papers') as mock_search:
            ...
            with patch.object(self.paper_collector, 'get_paper_details') as mock_details:
                ...
                essential_papers = self.scoring_engine.select_essential_papers([], topic.essential_count)
                ...
                with patch.object(self.citation_service, 'batch_get_citation_counts') as mock_citations:
                    ...
                    with patch.object(self.impact_factor_service, 'get_impact_factor') as mock_if:
                        ...
                        for i in range(len(essential_papers) - 1):
                            assert essential_papers[i].score >= essential_papers[i + 1].score
    ...
    def test_cache_integration(self):
        ...
        with patch.object(self.citation_service.cache_manager, 'get_citation') as mock_cache_get:
            with patch.object(self.citation_service.cache_manager, 'save_citation') as mock_cache_save:
                # First call - cache miss
                mock_cache_get.return_value = None
                
                with patch('src.pubmed_miner.services.citation_service.requests.get') as mock_requests:
                    mock_response = Mock()
                    ...
                    count1 = self.citation_service.get_citation_count("12345", doi="10.1000/test")
                    assert count1 == 100
    ...
    def test_error_propagation_integration(self):
        ...
        from src.pubmed_miner.utils.error_handler import APIError, ValidationError
