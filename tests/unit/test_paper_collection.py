...
class TestPaperCollectionService:
    ...
    def test_retry_mechanism(self):
        ...
        with patch('src.pubmed_miner.services.paper_collection.Entrez.esearch') as mock_esearch:
            # First call fails, second succeeds
            mock_esearch.side_effect = [
                Exception("Temporary error"),
                Mock(read=Mock(return_value='<eSearchResult><IdList></IdList></eSearchResult>'))
            ]
    ...
    def test_get_statistics(self):
        ...
        required_keys = [
            'total_searches', 'total_papers_fetched', 'total_api_calls',
            'average_response_time', 'error_count', 'rate_limit_hits'
        ]
    ...
    def test_search_with_filters(self, mock_esearch):
        ...
        mock_handle = Mock()
        mock_handle.read.return_value = '<eSearchResult><IdList></IdList></eSearchResult>'
        mock_esearch.return_value = mock_handle
