...
class TestCSVManager:
    ...
    def test_append_papers_empty_list_does_not_raise_error(
        self, temp_csv_file, sample_papers
    ):
        """Test that appending empty list logs a warning but does not raise."""
