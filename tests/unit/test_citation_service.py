...
from src.pubmed_miner.utils.error_handler import APIError, RateLimitError
...
class TestCitationService:
    ...
    def test_pmid_to_doi_lookup(self):
        ...
        with patch('src.pubmed_miner.services.citation_service.Entrez.efetch') as mock_efetch:
            mock_handle = Mock()
    ...
    def test_get_statistics(self):
        ...
        required_keys = [
            'total_requests', 'cache_hits', 'cache_misses', 'api_calls',
            'crossref_calls', 'semantic_scholar_calls', 'error_count',
    ...
    def test_clear_expired_cache(self):
        ...
        with patch.object(self.service.cache_manager, 'clear_expired_citations') as mock_clear:
    ...
    def test_retry_mechanism(self):
        ...
        with patch('src.pubmed_miner.services.citation_service.requests.get') as mock_get:
            ...
            success_response.json.return_value = {'message': {'is-referenced-by-count': 100}}
