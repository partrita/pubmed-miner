...
from src.pubmed_miner.models import TopicConfig, GitHubConfig, ScoringWeights, SystemConfig
...
class TestConfigurationManager:
    ...
    def test_initialization(self):
        ...
        assert self.config_manager.settings_file == Path(self.temp_dir) / "settings.yaml"
