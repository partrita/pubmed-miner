...
def mock_entrez():
    ...
    with pytest.mock.patch(
        "src.pubmed_miner.services.paper_collection.Entrez"
    ) as mock_entrez:
        yield mock_entrez
...
def setup_test_environment():
    ...
    test_env = {"LOG_LEVEL": "DEBUG", "PUBMED_EMAIL": "test@example.com"}
...
def pytest_configure(config):
    ...
    config.addinivalue_line("markers", "external: mark test as requiring external APIs")
