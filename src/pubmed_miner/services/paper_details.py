...
from ..utils.error_handler import APIError, DataError, retry_api_calls
...
class PaperDetailsService:
    ...
    def _enrich_single_paper(self, paper: Paper) -> Paper:
        ...
        enriched_data = {
            ...
            'abstract': self._clean_abstract(paper.abstract or additional_data.get('abstract')),
    ...
    def calculate_relevance_score(self, paper: Paper, query: str) -> float:
        ...
        abstract_score = self._calculate_text_relevance(paper.abstract or "", query_terms)
