...
class ChangeTracker:
    ...
    def detect_changes(
        self, 
        topic: str, 
        current_papers: List[ScoredPaper]
    ) -> Dict[str, any]:
        ...
        has_changes = (
            changes['new_papers'] > 0 or 
            changes['removed_papers'] > 0 or 
            changes['rank_changes'] > 0 or
            changes['significant_score_changes'] > 0
        )
    ...
    def _analyze_changes(
        ...
        current_dict: Dict[str, ScoredPaper]
    ) -> Dict[str, any]:
    ...
    def _create_change_summary(self, changes: Dict[str, any]) -> str:
        ...
        if changes['significant_score_changes'] > 0:
            summary_parts.append(f"{changes['significant_score_changes']} significant score changes")
